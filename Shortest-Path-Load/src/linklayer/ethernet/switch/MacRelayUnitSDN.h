...
#ifndef __SHORTESTPATHLOAD_SRC_LINKLAYER_ETHERNET_SWITCH_MACRELAYUNITSDN_H
#define __SHORTESTPATHLOAD_SRC_LINKLAYER_ETHERNET_SWITCH_MACRELAYUNITSDN_H
...
class MacRelayUnitSDN : public LayeredProtocolBase
{
protected:
...
protected:
  ...
  //EXTRA BEGIN
  virtual bool isControlerMessage(cMessage *message) const { return message->arrivedOn("controllerIn"); }
  virtual void handleMessageWhenUp(cMessage *message) override; //from LayeredProtocolBase
  virtual void handleControllerMessage(cMessage *message);
  virtual void handleControllerCommand(cMessage *message);
  virtual void handleControllerPacket(Packet *packet);
...
#endif // ifndef __SHORTESTPATHLOAD_SRC_LINKLAYER_ETHERNET_SWITCH_MACRELAYUNITSDN_H
